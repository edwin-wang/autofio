...
rw_var = ["write", "read", "rw", "randwrite", "randread", "randrw"]
bs_var = ["512", "1k", "2k", "4k", "8k", "16k", "32k", "64k", "128k", "256k", "512k", "1m", "2m", "4m", "8m"]
iodepth_var = ["1", "2", "4", "8", "16", "32", "64", "128"]
...
for rw_item in rw_var:
  for bs_item in bs_var:
    for iodepth_item in iodepth_var:
      ...
      fio_opt = " --ioengine=libaio --prio=0 --numjobs=1 --direct=1 --fadvise_hint=0 --bwavgtime=5000 --time_based --norandommap --verify=md5 "
      fio_opt += " --rw=" + rw_item
      fio_opt += " --bs=" + bs_item
