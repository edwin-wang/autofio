...
rw_var = ["read", "write", "rw", "randread", "randwrite", "randrw"]
bs_var = ["512", "1k", "2k", "4k", "8k", "16k", "32k", "64k", "128k", "256k", "512k", "1m", "2m", "4m", "8m"]
iodepth_var = ["1", "16", "32", "64"]

# ####################################################################
# find installed fio
# ####################################################################

if not os.path.exists("/usr/local/bin/fio"):
  print "fio isn't installed. Can not find fio at /usr/local/bin/fio."
  sys.exit()
